...
<head>
    ...
    <link href="{{asset('assets/css/core/family.Nunito.css')}}" rel="stylesheet">
    ...
    <script src="{{asset('assets/js/core/dataTables.bootstrap5.min.js')}}"></script>
    <script src="{{asset('assets/js/core/dataTables.buttons.min.js')}}"></script>
    <script src="{{asset('assets/js/core/buttons.bootstrap5.min.js')}}"></script>
    ...
    <script src="{{asset('assets/js/core/buttons.colVis.min.js')}}"></script>
            ...
            <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
                ...
                <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                      <a class="nav-link text-white " href="{{ route('changePassword') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
