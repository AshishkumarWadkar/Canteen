              ...
              <div class="card my-4">
                ...
                <div class="mx-3 my-2 row">
                    ...
                    <form action="{{ route('settlement.index') }}">
                        ...
                        <input type="date" class="" id="to" name="to"  value="{{ isset($to_date) ? $to_date : "" }}">
                        <button class="btn btn-sm btn-success mt-2" type="submit">Get Data</button>
<br>
                        <label class="text-uppercase text-secondary font-weight-bolder" for="amount">Amount</label>
                        <input type="text" class="" id="amount" name="amount"  value="{{ isset($amount) ? $amount : "" }}">

                        <label class="text-uppercase text-secondary font-weight-bolder" for="to">Payable</label>
                        <input type="text" class="" id="payable" name="payable"  value="{{ isset($payable) ? $payable : "" }}">
                    ...
                    <table class="table text-center mb-0 datatable">
                      <thead>
                        <tr>
                          ...
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">To Date</th>
