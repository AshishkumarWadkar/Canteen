                    ...
                    <div class="card my-4">
                        ...
                        <div class="mx-3 my-2 row">
                            ...
                            <div class="col-12 my-2">
                                <form class="col-12 row" action="{{ url()->current() }}">
                                    <div class="col-12 col-md-4 my-auto">
                                        <div class="input-group input-group-outline mb-3">
                                            <label class="text-uppercase text-secondary font-weight-bolder col-3" for="from"
                                    ...
                                    <div class="col-12 col-md-4 my-auto">
                                        <div class="input-group input-group-outline mb-3">
                                        <label class="text-uppercase text-secondary font-weight-bolder col-3"
                                            for="to">To :</label>
                                    ...
                                    <div class="col-6 col-md-1">
                                        <a  href="{{ route('missleanious.index') }}"
                                         class="btn btn-sm btn-success mt-2 mx-1" value="Reset">Reset
                                        </a>
                                        ...
                                        @foreach ($missleanious as $key => $ms)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center ">
                                                    <span
                                                        class="badge badge-sm bg-gradient-{{ $ms->paid_status == 1 ? 'success' : 'primary' }}">{{ $ms->paid_status == 1 ? 'Paid' : 'Due' }}</span>
                                                </td>
                                                ...
                                                <td class="text-start align-middle text-center ">
                                                    <form action="{{ route('misslenious_status_update', $ms->id) }}"
                                                        ...
                                                        {{ csrf_field() }}
                                                        <button type="button" class="btn btn-sm btn-primary show_confirm"
                                                            {{ $ms->paid_status == 1 ? 'disabled' : '' }}>Change
                                                            Status</button>
                                                    </form>
