                      ...
                      <tbody>
                        ...
                        <tr>
                          <td scope="row">{{ $key+1 }}</td>
                             ...
                             {{-- <td>{{ $pb->veg_nonveg == 0 ? "Veg" : "NonVeg" }}</td> --}}
                             <td class="text-start">{{ $pb->menu_name }}</td>
                             <td>{{  \Carbon\Carbon::parse($pb->booking_date)->format('d-m-Y') }}</td>
                          <td>
                                <a href="{{ route('menu_master.edit',$pb->id) }}"><button class="btn btn-sm btn-primary py-0">Edit</button></a>
