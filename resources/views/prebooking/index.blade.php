                        ...
                        <div class="table-responsive">
                            <div class="row">
                                <div class="col-6 row">
                                    ...
                                    <form class="col-6 row" action="{{ route('prebooking.index') }}">
                                        <div class="col-8">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <a class="btn btn-success btn-sm"
                                                href="{{ route('prebooking.index') }}">Reset</a>
                                        </div>
                                    </form>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th
                                            ...
                                            Type</th>
                                        <th
                                            class="text-start text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                            Description</th>
                                ...
                                <tbody>
                                    @foreach ($prebookings as $key => $pb)
                                        <tr>
                                            ...
                                            <td class="text-start">{{ $pb->type == 0 ? 'Breakfast' : '' }}
                                                {{ $pb->type == 1 ? 'Lunch' : '' }}</td>
